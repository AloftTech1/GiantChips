        ...
        <div className="glass-strong rounded-3xl p-12 md:p-16 max-w-2xl mx-auto border-3 border-gold/50">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              lassName="w-full bg-gradient-to-r from-gold to-brown-light hover:from-gold-light hover:to-brown text-cream font-semibold py-4 rounded-full transition-smooth disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-2xl border-2 border-gold/60 glass-light"
            >
